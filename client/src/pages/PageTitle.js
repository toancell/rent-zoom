...
const PageTitle = ({data}) => {
  return (
    <div className='flex flex-col items-start mt-3 w-full justify-center'>
        <h1 className='text-3xl font-bold'>{data.title} Cho Thuê Nhà Nguyên Căn, Giá Rẻ, Chính Chủ, Mới Nhất 2024</h1>
        <h2 className="text-sm text-gray-500">{data.subtitle} Cho thuê nhà nguyên căn, nhà riêng: giá rẻ, chính chủ, đầy đủ tiện nghi. Tìm thuê nhà với nhiều mức giá khác nhau, đa dạng loại diện tích. Đăng tin cho thuê nhà nhanh, hiệu quả tại phongtro123.com</h2>
